...
def train_all_classifiers (train_input, train_labels):
    ...
    global word_unigram_vectorizer, word_bigram_vectorizer
    global char_3gram_vectorizer, char_5gram_vectorizer
    global MNB_word_unigram_model, MNB_word_bigram_model
    global SVM_word_unigram_model, SVM_word_bigram_model
...
try:
    ...
    ## loads classifiers
    MNB_word_unigram_model = load_model ("./app/static/models/MNB_model_word_unigram.pckl")
    MNB_word_bigram_model = load_model ("./app/static/models/MNB_model_word_bigram.pckl")

    SVM_word_unigram_model = load_model ("./app/static/models/SVM_model_word_unigram.pckl")
    SVM_word_bigram_model = load_model ("./app/static/models/SVM_model_word_bigram.pckl")

    SVM_char_3gram_model = load_model ("./app/static/models/SVM_model_char_3gram.pckl")
    SVM_char_5gram_model = load_model ("./app/static/models/SVM_model_char_5gram.pckl")
